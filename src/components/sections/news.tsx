    ...
    <section id="news" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          {toShow.map(article => (
            <Card key={article.id} className="overflow-hidden card-hover group cursor-pointer p-0 flex flex-col">
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground mt-auto">
                  ...
                  <Button variant="ghost" size="sm" className="text-[#1e3a8a] dark:text-[#c9a84c] p-0 h-auto">
                    {t("news.readMore")}
